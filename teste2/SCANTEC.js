...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/0.14.3/dist/wheels/bokeh-2.4.3-py3-none-any.whl', 'https://cdn.holoviz.org/panel/0.14.3/dist/wheels/panel-0.14.3-py3-none-any.whl', 'pyodide-http==0.1.0', 'aiohttp', 'cartopy', 'dask', 'fsspec[http]', 'holoviews', 'hvplot', 'pandas', 'panel-modal', 'requests', 'xarray', 'xgrads', 'zarr']
