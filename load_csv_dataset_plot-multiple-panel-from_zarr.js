...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/0.14.3/dist/wheels/bokeh-2.4.3-py3-none-any.whl', 'https://cdn.holoviz.org/panel/0.14.3/dist/wheels/panel-0.14.3-py3-none-any.whl', 'pyodide-http==0.1.0', 'cartopy', 'cartopy', 'cartopy', 'cartopy', 'cartopy', 'cartopy', 'cartopy', 'dask', 'geopandas-base', 'geos', 'geoviews', 'holoviews', 'hvplot', 'intake', 'intake-esm', 'intake-xarray', 'jupyter', 'matplotlib', 'nbconvert', 'notebook', 'numba', 'numpy', 'pandas', 'panel-modal', 'pip', 'proj', 'pyproj', 'python', 'python-dateutil', 'scipy', 'seaborn', 'skillmetrics', 'xarray', 'xgrads', 'zarr']
