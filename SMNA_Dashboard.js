...
dfs = pd.read_csv('https://raw.githubusercontent.com/cfbastarz/teste/main/data/jo_table_series.csv', header=[0, 1], parse_dates=[('df_dtc', 'Date'),('df_bamh_T0', 'Date'),('df_bamh_T4', 'Date'),('df_bamh_GT4AT2', 'Date')])
